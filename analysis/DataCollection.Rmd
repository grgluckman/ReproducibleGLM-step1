...
### For help look at http://topepo.github.io/caret/
library(caret)
ncol(titanic_all)
...
summary(titanic_all_numeric)
cor(titanic_all_numeric[,-1]
    , use="pairwise.complete.obs")

summary(titanic_all_numeric$survived)    
cor(titanic_all_numeric$survived
    ,titanic_all_numeric$age
    , use="pairwise.complete.obs")
summary(titanic_all_numeric$body)

caret::findCorrelation(cor(titanic_all_numeric[,-1]
      , use="pairwise.complete.obs"))
